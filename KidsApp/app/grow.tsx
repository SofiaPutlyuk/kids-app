...
//         <Image source={require("../assets/images/grow.png")} style={styles.image}/>
//         <Text style={styles.textExplore}>Grow</Text>
//         <Text style={styles.textInterest}>Earn start and grow your own mosnter!</Text>
//         <Image style={styles.ellipseBackground} source={require("../assets/images/background-ellipse.png")} />
//            <TouchableOpacity style={styles.buttonContinueRead} onPress={() => router.push("/explore")}>
//                         <LinearGradient
